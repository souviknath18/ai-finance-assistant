...
export default function SubscriptionFilterModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-xl overflow-hidden rounded-3xl border border-[#dce9ff] bg-white shadow-[0_24px_70px_rgba(15,23,42,0.25)]">
        <div className="flex max-h-[90vh] flex-col">
          {/* HEADER */}
          <div className="flex items-start justify-between gap-5 border-b border-[#eef2ff] bg-white px-6 pb-4 pt-6">
            <div className="flex items-start gap-3">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#dce9ff] text-black">
                <Filter size={22} />
              </div>
          ...
          <div className="custom-scrollbar flex-1 overflow-y-auto px-6 py-5">
            <div className="space-y-7">
              ...
              <section className="rounded-3xl border border-emerald-100 bg-emerald-50/60 p-5">
                ...
                <div className="mt-2 flex justify-between text-xs font-semibold text-[#565e74]">
                  <span>₹0</span>
                  <span>₹10,000+</span>
                </div>
              </section>
          ...
          {/* FOOTER */}
          <div className="flex flex-col-reverse gap-3 border-t border-[#eef2ff] bg-white px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
            <button
              type="button"
              onClick={handleClear}
              className="flex items-center justify-center gap-2 rounded-xl border border-[#c6c6cd] px-5 py-3 text-sm font-bold text-black transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"
            >
              <RotateCcw size={16} />
              Clear All
            </button>
            ...
            <div className="flex flex-col-reverse gap-3 sm:flex-row">
              <button
                type="button"
                onClick={onCloseAction}
                className="rounded-xl border border-[#c6c6cd] px-5 py-3 text-sm font-bold text-black transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"
              >
                Cancel
              </button>
...
function SectionTitle({
  ...
  return (
    <p className="mb-3 text-xs font-bold uppercase tracking-wider text-[#7c839b]">
      {children}
    </p>
  );
}
...
function OptionBox({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`group relative overflow-hidden rounded-2xl border p-4 text-sm font-bold transition-all duration-200 ${
        active
          ? "border-emerald-300 bg-emerald-50 text-emerald-700 shadow-sm"
          : "border-[#c6c6cd] bg-white text-[#565e74] hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700"
      }`}
