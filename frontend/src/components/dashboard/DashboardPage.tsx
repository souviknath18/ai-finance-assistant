      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
        ...
        <aside className="min-w-0 space-y-4 xl:col-span-4">
          ...
          <SubscriptionsOverviewCard
            ...
            monthlyTotal={
              data.subscriptions_monthly_total
            }
          />
