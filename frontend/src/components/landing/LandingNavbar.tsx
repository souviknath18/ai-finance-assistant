      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4">
        ...
        >
          ...
          <div className="min-w-0 leading-tight">
            ...
            <p className="hidden text-[9px] font-semibold uppercase tracking-[0.08em] text-[#7c839b] min-[380px]:block sm:hidden">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link
            href="/auth/login"
            className="inline-flex h-9 items-center justify-center rounded-xl px-3 text-[11px] font-bold text-[#45464d] transition hover:bg-[#f8faff] hover:text-black sm:px-4 sm:text-[12px]"
          >
            Login
          </Link>
